...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_games_shop_sounds__ = __webpack_require__(/*! games/shop/sounds */ 167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_mainComponent__ = __webpack_require__(/*! ./components/mainComponent */ 265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images__ = __webpack_require__(/*! ./images */ 154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__levels__ = __webpack_require__(/*! ./levels */ 274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__logic__ = __webpack_require__(/*! ./logic */ 168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__logic__ = __webpack_require__(/*! ./logic */ 168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_ui_animations_commonAnimations__ = __webpack_require__(/*! core/ui/animations/commonAnimations */ 27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_ui_animations_signals__ = __webpack_require__(/*! core/ui/animations/signals */ 22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_ui_animations_tweens__ = __webpack_require__(/*! core/ui/animations/tweens */ 25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_ui_common_sizes__ = __webpack_require__(/*! core/ui/common/sizes */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_ui_components_games_baseMainGameComponent__ = __webpack_require__(/*! core/ui/components/games/baseMainGameComponent */ 138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_core_ui_components_games_tutorialTextComponent__ = __webpack_require__(/*! core/ui/components/games/tutorialTextComponent */ 142);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_core_utils__ = __webpack_require__(/*! core/utils */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_core_utils_numbers__ = __webpack_require__(/*! core/utils/numbers */ 29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_games_shop_components_answersComponent__ = __webpack_require__(/*! games/shop/components/answersComponent */ 266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_games_shop_components_fishComponent__ = __webpack_require__(/*! games/shop/components/fishComponent */ 268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_games_shop_components_roomClockComponent__ = __webpack_require__(/*! games/shop/components/roomClockComponent */ 269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_games_shop_components_roomComponent__ = __webpack_require__(/*! games/shop/components/roomComponent */ 270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_games_shop_components_roomDarkComponent__ = __webpack_require__(/*! games/shop/components/roomDarkComponent */ 272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_games_shop_images__ = __webpack_require__(/*! games/shop/images */ 154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_games_shop_sounds__ = __webpack_require__(/*! games/shop/sounds */ 167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_games_shop_translations__ = __webpack_require__(/*! games/shop/translations */ 273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_lodash__ = __webpack_require__(/*! lodash */ 1);
...
var positions = __WEBPACK_IMPORTED_MODULE_7_core_ui_common_sizes__["a" /* Sizes */].create({
    statusOffset: -150,
...
var positionsPortrait = __WEBPACK_IMPORTED_MODULE_7_core_ui_common_sizes__["a" /* Sizes */].expand(positions, {
...
var MainComponent = /** @class */ (function (_super) {
    ...
    function MainComponent() {
        ...
        _this.light = _this.addImage([__WEBPACK_IMPORTED_MODULE_19_games_shop_images__["a" /* Images */].light, positions.light]);
        _this.fish = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_15_games_shop_components_fishComponent__["a" /* FishComponent */])).setPos(positions.fish);
        ...
        _this.clock = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_16_games_shop_components_roomClockComponent__["a" /* RoomClockComponent */])).setPos(positions.arrow);
        _this.shelfs = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_17_games_shop_components_roomComponent__["a" /* RoomComponent */]))
            ...
            .anchorCenterX();
        _this.flow = _this.addImage([__WEBPACK_IMPORTED_MODULE_19_games_shop_images__["a" /* Images */].flow(0), positions.flow]);
        ...
        _this.catFrames = __WEBPACK_IMPORTED_MODULE_11_core_ui_services_instances__["d" /* screenSizeService */].isPortrait ? [0, 1, 3, 2] : [0, 1, 0, 2];
        return _this;
    }
    ...
    MainComponent.prototype.onInit = function () {
        ...
        this.readyBtn = this.add(new __WEBPACK_IMPORTED_MODULE_10_core_ui_controls__["f" /* ThreeSliceBtn */](__WEBPACK_IMPORTED_MODULE_22_lodash__["upperFirst"](__WEBPACK_IMPORTED_MODULE_2_core_services__["f" /* translationService */].getTranslation(__WEBPACK_IMPORTED_MODULE_21_games_shop_translations__["a" /* Translations */].remember)), __WEBPACK_IMPORTED_MODULE_19_games_shop_images__["a" /* Images */].buttList.map(function (x) { return _this.gameKey(x); }), function () { return _this.onReady(); }, __WEBPACK_IMPORTED_MODULE_1_core_assets__["c" /* CoreFonts */].button("#3D7AAD")))
            .anchorCenterX()
            .updatePos(__WEBPACK_IMPORTED_MODULE_7_core_ui_common_sizes__["a" /* Sizes */].w2, positions.buttonY);
        ...
        if (this.isTutorial) {
            this.tutorial = this.add(this.createComponent(__WEBPACK_IMPORTED_MODULE_9_core_ui_components_games_tutorialTextComponent__["a" /* TutorialTextComponent */])).make();
        }
        this.updateState(0);
        this.startIntro();
    };
    MainComponent.prototype.showTutorial = function (state) {
        if (this.isTutorial) {
            ...
            var text = key ? __WEBPACK_IMPORTED_MODULE_2_core_services__["f" /* translationService */].getTranslation(key) : "";
    ...
    MainComponent.prototype.changeItems = function (dark) {
        ...
        var signal = this.disableInputOn(this.delay(durations.transition));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_ui_controls_imgWithShadow__ = __webpack_require__(/*! core/ui/controls/imgWithShadow */ 267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_ui_services_instances__ = __webpack_require__(/*! core/ui/services/instances */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_core_utils__ = __webpack_require__(/*! core/utils */ 8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__images__ = __webpack_require__(/*! ../images */ 154);
...
var AnswersComponent = /** @class */ (function (_super) {
    ...
    function AnswersComponent() {
        ...
        _this.group = _this.add(new __WEBPACK_IMPORTED_MODULE_6_core_ui_controls__["b" /* Control */]()).updateAnchor(0.5, __WEBPACK_IMPORTED_MODULE_8_core_ui_services_instances__["d" /* screenSizeService */].isPortrait ? 0 : 0.5);
        _this.rng = new __WEBPACK_IMPORTED_MODULE_9_core_utils__["e" /* RandomGenerator */]();
        return _this;
    }
    AnswersComponent.prototype.onInit = function () {
        var _this = this;
        this.onChangeForRun(function () { return __WEBPACK_IMPORTED_MODULE_8_core_ui_services_instances__["d" /* screenSizeService */].isPortrait; }, function (x) {
            _this.updatePositions();
        });
    };
    AnswersComponent.prototype.updatePositions = function () {
        var colCount = __WEBPACK_IMPORTED_MODULE_8_core_ui_services_instances__["d" /* screenSizeService */].isPortrait ? 4 : 8;
        __WEBPACK_IMPORTED_MODULE_4_core_ui_common_sizes__["a" /* Sizes */].tableFromList(this.images, colCount, getPositions().margin);
        this.group.updatePivot();
        this.group.updatePos(__WEBPACK_IMPORTED_MODULE_4_core_ui_common_sizes__["a" /* Sizes */].w2, getPositions().y);
    };
    ...
    AnswersComponent.prototype.onPropsUpdate = function () {
        ...
        this.images = this.props.map(function (item) {
            ...
            btn.symmetricScale = __WEBPACK_IMPORTED_MODULE_8_core_ui_services_instances__["d" /* screenSizeService */].isPortrait ? 0.8 : 1;
            btn.anchorCenter();
...
var ImageWithShadow = /** @class */ (function (_super) {
    ...
    function ImageWithShadow(key) {
        ...
        var shadow = _this.add(__WEBPACK_IMPORTED_MODULE_1_core_ui_controls_index__["d" /* Img */].makeSprite(key));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_ui_components__ = __webpack_require__(/*! core/ui/components */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_utils__ = __webpack_require__(/*! core/utils */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_games_shop_images__ = __webpack_require__(/*! games/shop/images */ 154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_games_shop_sounds__ = __webpack_require__(/*! games/shop/sounds */ 167);
...
var FishComponent = /** @class */ (function (_super) {
    ...
    function FishComponent() {
        ...
        _this.fish = _this.addImage([__WEBPACK_IMPORTED_MODULE_5_games_shop_images__["a" /* Images */].fish(_this.getNextFrame()), positions.fish]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(/*! tslib */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_ui_components__ = __webpack_require__(/*! core/ui/components */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_games_shop_images__ = __webpack_require__(/*! games/shop/images */ 154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_games_shop_sounds__ = __webpack_require__(/*! games/shop/sounds */ 167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_utils__ = __webpack_require__(/*! core/utils */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_games_shop_components_roomShelfComponent__ = __webpack_require__(/*! games/shop/components/roomShelfComponent */ 271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_games_shop_logic__ = __webpack_require__(/*! games/shop/logic */ 168);
...
var RoomComponent = /** @class */ (function (_super) {
    ...
    RoomComponent.prototype.line = function (index, shelf) {
        var y = positions.marginTop + index * positions.shelfHeight;
        shelf.updatePos(0, y);
    };
...
var RoomShelfComponent = /** @class */ (function (_super) {
    ...
    function RoomShelfComponent() {
        ...
        _this.images = [];
        _this.itemScale = __WEBPACK_IMPORTED_MODULE_5_games_shop_images__["a" /* Images */].sizes.itemSmall / __WEBPACK_IMPORTED_MODULE_5_games_shop_images__["a" /* Images */].sizes.item;
        return _this;
    }
    ...
    RoomShelfComponent.prototype.getItemX = function (position) {
        return (positions.between + __WEBPACK_IMPORTED_MODULE_5_games_shop_images__["a" /* Images */].sizes.itemSmall) * position;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tslib__ = __webpack_require__(/*! tslib */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_ui_common_sizes__ = __webpack_require__(/*! core/ui/common/sizes */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_ui_components__ = __webpack_require__(/*! core/ui/components */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_utils__ = __webpack_require__(/*! core/utils */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_games_shop_images__ = __webpack_require__(/*! games/shop/images */ 154);
...
var RoomDarkComponent = /** @class */ (function (_super) {
    ...
    RoomDarkComponent.prototype.onInit = function () {
        ...
        this.addImage([__WEBPACK_IMPORTED_MODULE_4_games_shop_images__["a" /* Images */].toktokDark, positions.toktok]);
    };
