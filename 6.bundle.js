...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_games_compositor_sounds__ = __webpack_require__(/*! games/compositor/sounds */ 203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_mainComponent__ = __webpack_require__(/*! ./components/mainComponent */ 223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images__ = __webpack_require__(/*! ./images */ 167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__levels__ = __webpack_require__(/*! ./levels */ 230);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_assets_images__ = __webpack_require__(/*! core/assets/images */ 46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_ui_common_sizes__ = __webpack_require__(/*! core/ui/common/sizes */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_games_compositor_logic__ = __webpack_require__(/*! games/compositor/logic */ 193);
...
(function (Images) {
    var earCount = 2;
    var eguazCount = 40;
    Images.sizes = function () { return __WEBPACK_IMPORTED_MODULE_1_core_ui_common_sizes__["a" /* Sizes */].create({
        sound: { w: 125, h: 100 },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_utils_arrays__ = __webpack_require__(/*! core/utils/arrays */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_utils_circleSeq__ = __webpack_require__(/*! core/utils/circleSeq */ 157);
...
(function (Fonts) {
    Fonts.adv = {
        fontSize: 36, font: "Arial", fill: "#3E4C59", fontStyle: "italic"
    };
    Fonts.copyright = {
        fontSize: 36, font: "Arial", fill: "#3E4C59"
    };
})(Fonts || (Fonts = {}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_games_compositor_logic__ = __webpack_require__(/*! games/compositor/logic */ 193);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_ui_common_sizes__ = __webpack_require__(/*! core/ui/common/sizes */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_ui_components_games_baseMainGameComponent__ = __webpack_require__(/*! core/ui/components/games/baseMainGameComponent */ 156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_ui_components_games_gameUI_tutorialTextComponent__ = __webpack_require__(/*! core/ui/components/games/gameUI/tutorialTextComponent */ 158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_games_compositor_components_drumMachineComponent__ = __webpack_require__(/*! games/compositor/components/drumMachineComponent */ 224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_games_compositor_images__ = __webpack_require__(/*! games/compositor/images */ 167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_games_compositor_translations__ = __webpack_require__(/*! games/compositor/translations */ 194);
...
var MainComponent = /** @class */ (function (_super) {
    ...
    function MainComponent() {
        ...
        _this.getPositions = function () { return __WEBPACK_IMPORTED_MODULE_7_core_ui_services_instances__["e" /* screenSizeService */].isPortrait ? _this.positionsPortrait : _this.positions; };
    ...
    MainComponent.prototype.onInit = function () {
        ...
        this.startIntro();
        if (this.isTutorial) {
            this.tutorial = this.add(this.createComponent(__WEBPACK_IMPORTED_MODULE_6_core_ui_components_games_gameUI_tutorialTextComponent__["a" /* TutorialTextComponent */]).make());
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_games_compositor_components_answerCountComponent__ = __webpack_require__(/*! games/compositor/components/answerCountComponent */ 225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_games_compositor_components_answersComponent__ = __webpack_require__(/*! games/compositor/components/answersComponent */ 227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_games_compositor_components_taskComponent__ = __webpack_require__(/*! games/compositor/components/taskComponent */ 228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_games_compositor_images__ = __webpack_require__(/*! games/compositor/images */ 167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_games_compositor_sounds__ = __webpack_require__(/*! games/compositor/sounds */ 203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_games_compositor_translations__ = __webpack_require__(/*! games/compositor/translations */ 194);
...
var DrumMachineComponent = /** @class */ (function (_super) {
    ...
    function DrumMachineComponent() {
        ...
        _this.answerCount = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_10_games_compositor_components_answerCountComponent__["a" /* AnswerCountComponent */])).setPos(_this.positions.answerCount);
        _this.answers = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_11_games_compositor_components_answersComponent__["a" /* AnswersComponent */])).anchorCenterX().updatePos(_this.center()[0], _this.positions.panel[1]);
        _this.task = _this.add(_this.createComponent(__WEBPACK_IMPORTED_MODULE_12_games_compositor_components_taskComponent__["a" /* TaskComponent */])).anchorCenter().updatePos(_this.center()[0], _this.positions.taskY);
        _this.earPanel = _this.createPanel();
        return _this;
    }
    DrumMachineComponent.prototype.onInit = function () {
        this.add(new __WEBPACK_IMPORTED_MODULE_9_core_ui_controls_txt__["a" /* Txt */]("Wikium", __WEBPACK_IMPORTED_MODULE_15_games_compositor_translations__["a" /* Fonts */].adv)).setPos(this.positions.adv);
        this.add(new __WEBPACK_IMPORTED_MODULE_9_core_ui_controls_txt__["a" /* Txt */]("©", __WEBPACK_IMPORTED_MODULE_15_games_compositor_translations__["a" /* Fonts */].copyright)).setPos(this.positions.copyright);
    };
    ...
    DrumMachineComponent.prototype.createPanel = function () {
        ...
        panel.setPos(this.positions.panel);
        return panel;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_ui_controls_behaviors_changeImageKeyBehavior__ = __webpack_require__(/*! core/ui/controls/behaviors/changeImageKeyBehavior */ 226);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__images__ = __webpack_require__(/*! ../images */ 167);
...
var AnswerCountComponent = /** @class */ (function (_super) {
    ...
    AnswerCountComponent.prototype.onPropsUpdate = function () {
        var _this = this;
        var pos = __WEBPACK_IMPORTED_MODULE_7_lodash__["flatMap"](this.positions.x, function (x) { return _this.positions.y.map(function (y) { return Object(__WEBPACK_IMPORTED_MODULE_6_core_utils_tuples__["a" /* tuple */])(x, y); }); });
        this.removeAll(true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_ui_services_instances__ = __webpack_require__(/*! core/ui/services/instances */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_utils__ = __webpack_require__(/*! core/utils */ 9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_utils_arrays__ = __webpack_require__(/*! core/utils/arrays */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_dev__ = __webpack_require__(/*! dev */ 13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__images__ = __webpack_require__(/*! ../images */ 167);
...
var AnswersComponent = /** @class */ (function (_super) {
    ...
    AnswersComponent.prototype.onInit = function () {
        var _this = this;
        this.onChangeForRun(function () { return __WEBPACK_IMPORTED_MODULE_6_core_ui_services_instances__["e" /* screenSizeService */].isPortrait; }, function (x) {
    ...
    AnswersComponent.prototype.updatePositions = function () {
        var colCount = 4;
        __WEBPACK_IMPORTED_MODULE_3_core_ui_common_sizes__["a" /* Sizes */].tableFromList(this.buttons, colCount, this.positions.margin);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_ui_services_instances__ = __webpack_require__(/*! core/ui/services/instances */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_utils_undef__ = __webpack_require__(/*! core/utils/undef */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_games_compositor_components_equalizerComponent__ = __webpack_require__(/*! games/compositor/components/equalizerComponent */ 229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_games_compositor_translations__ = __webpack_require__(/*! games/compositor/translations */ 194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__images__ = __webpack_require__(/*! ../images */ 167);
...
var TaskComponent = /** @class */ (function (_super) {
    ...
    function TaskComponent() {
        ...
        _this.text = _this.add(new __WEBPACK_IMPORTED_MODULE_6_core_ui_controls_txt__["a" /* Txt */]("", __WEBPACK_IMPORTED_MODULE_1_core_assets_fonts__["c" /* CoreFonts */].tutorial(false)));
    ...
    TaskComponent.prototype.onInit = function () {
        var _this = this;
        this.text.textControl.wordWrapWidth = this.positions.wordWrap;
        this.onChangeForRun(function () { return __WEBPACK_IMPORTED_MODULE_7_core_ui_services_instances__["e" /* screenSizeService */].isPortrait; }, function (x) {
            _this.updatePositions();
        });
    };
    ...
    TaskComponent.prototype.updatePositions = function () {
        var colCount = 5;
        __WEBPACK_IMPORTED_MODULE_3_core_ui_common_sizes__["a" /* Sizes */].tableFromList(this.sounds, colCount, this.positions.marginSound);
        __WEBPACK_IMPORTED_MODULE_3_core_ui_common_sizes__["a" /* Sizes */].tableFromList(this.equalizers, colCount, this.positions.marginEqualizer);
    };
        ...
        var states = {
            text: function () {
                ...
                _this.groupExclude.addChildren(exclude)
                    .updatePos(_this.text.width / 2, _this.positions.excludeY);
                __WEBPACK_IMPORTED_MODULE_3_core_ui_common_sizes__["a" /* Sizes */].tableRow(exclude, _this.positions.excludeMargin);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_utils_arrays__ = __webpack_require__(/*! core/utils/arrays */ 26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(/*! lodash */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__images__ = __webpack_require__(/*! ../images */ 167);
...
var EqualizerComponent = /** @class */ (function (_super) {
    ...
    EqualizerComponent.prototype.setMinimum = function (animation) {
        ...
        this.images.forEach(function (x) {
            if (!animation) {
                //   Tweens.start({
                //     target: x,
                //     to: {height: this.positions.minHeight},
                //     duration: 300,
                //   })
                // }else{
                x.height = _this.positions().minHeight;
            }
        });
    };
    EqualizerComponent.prototype.onPropsUpdate = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_core_ui_common_sizes__["a" /* Sizes */].tableRow(this.images, this.positions().margin);
    };
