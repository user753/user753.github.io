...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_games_polyglot_writer_images__ = __webpack_require__(/*! games/polyglot/writer/images */ 192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_games_polyglot_writer_sounds__ = __webpack_require__(/*! games/polyglot/writer/sounds */ 193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_mainComponent__ = __webpack_require__(/*! ./components/mainComponent */ 253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__levels__ = __webpack_require__(/*! ./levels */ 256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__logic__ = __webpack_require__(/*! ./logic */ 260);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_games_polyglot_common_wordsSounds__ = __webpack_require__(/*! games/polyglot/common/wordsSounds */ 145);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_games_polyglot_common_commonWords__ = __webpack_require__(/*! games/polyglot/common/commonWords */ 257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_games_polyglot_writer_wordsEn__ = __webpack_require__(/*! games/polyglot/writer/wordsEn */ 258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_games_polyglot_writer_wordsRu__ = __webpack_require__(/*! games/polyglot/writer/wordsRu */ 259);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_games_utils_localeUtl__ = __webpack_require__(/*! games/utils/localeUtl */ 165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_utils_undef__ = __webpack_require__(/*! core/utils/undef */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_games_polyglot_common_components_baseWordMainComponent__ = __webpack_require__(/*! games/polyglot/common/components/baseWordMainComponent */ 159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_games_polyglot_writer_components_typeWriterComponent__ = __webpack_require__(/*! games/polyglot/writer/components/typeWriterComponent */ 254);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_games_polyglot_writer_translations__ = __webpack_require__(/*! games/polyglot/writer/translations */ 255);
...
var MainComponent = /** @class */ (function (_super) {
    ...
    MainComponent.prototype.updateTutorialState = function (step) {
        ...
        var states = [
            ...
            function () {
                _this.tutorial.setProps(__WEBPACK_IMPORTED_MODULE_1_core_services__["f" /* translationService */].getTranslation(__WEBPACK_IMPORTED_MODULE_9_games_polyglot_writer_translations__["a" /* Translations */].title3));
            },
        ];
    ...
    MainComponent.prototype.onInit = function () {
        ...
        this.positions = __WEBPACK_IMPORTED_MODULE_3_core_ui_common_sizes__["a" /* Sizes */].update(this.positions, {
            mainGroup: { y: 130 },
            wordlistOffset: { x: 24, y: (this.isTutorial && __WEBPACK_IMPORTED_MODULE_5_core_ui_services_instances__["d" /* screenSizeService */].isPortrait) ? -80 : 0 }
        });
        ...
        this.hintComponent.tooltip = __WEBPACK_IMPORTED_MODULE_1_core_services__["f" /* translationService */].getTranslation(__WEBPACK_IMPORTED_MODULE_9_games_polyglot_writer_translations__["a" /* Translations */].hint);
    ...
    MainComponent.prototype.createTutorial = function () {
        return this.add(this.createComponent(__WEBPACK_IMPORTED_MODULE_4_core_ui_components_games_tutorialTextComponent__["a" /* TutorialTextComponent */])).make({
            minHeight: getPositions().tutorialMinHeight,
            stepCount: 3,
            textAlign: "center"
        });
    };
    MainComponent.prototype.updateTutorial = function () {
        if (this.tutorial) {
            ...
            var lines = [__WEBPACK_IMPORTED_MODULE_1_core_services__["f" /* translationService */].getTranslation(__WEBPACK_IMPORTED_MODULE_9_games_polyglot_writer_translations__["a" /* Translations */].title1), anagrammaText];
            this.tutorial.setProps(lines.join("\n"));
        }
    };
    MainComponent.prototype.tutorialText2 = function () {
        return __WEBPACK_IMPORTED_MODULE_1_core_services__["f" /* translationService */].getTranslation(__WEBPACK_IMPORTED_MODULE_9_games_polyglot_writer_translations__["a" /* Translations */].title2) + ": "
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_games_polyglot_common_components_baseTypewriterComponent__ = __webpack_require__(/*! games/polyglot/common/components/baseTypewriterComponent */ 164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_games_polyglot_writer_images__ = __webpack_require__(/*! games/polyglot/writer/images */ 192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_games_polyglot_writer_sounds__ = __webpack_require__(/*! games/polyglot/writer/sounds */ 193);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__words__ = __webpack_require__(/*! ./words */ 194);
...
(function (WordsEn) {
    WordsEn.data = {
        tutorial: [["fly", "hand", "foot"], ["night", "fox", "wolf"]],
        words: { "animal": { "single": "antelope, ram, badger, squirrel, bear, fox, beaver, bull, ox, wolf, viper, gorilla, boar, giraffe, hare, zebra, snake, lioness, kangaroo, goat, cow, cat, crocodile, rabbit, rat, lion, fox, elk, horse, panda, mouse, rhinoceros, monkey, sheep, deer, donkey, pony, piglet, lynx, elephant, tiger, seal, ferret, turtle, horse, llama, she-cat, sable, bison, leopard, jackal, mole, hamster, hyena, lemur, camel, porcupine, hippopotamus, dog, zebra, gopher, land-lance, chimpanzee, buffalo, sloth, puma, auroch, mammoth, baboon, cheetah, raccoon, koala, arctic fox, panther, jaguar, mongoose, ermine, manul cat", "phrases": "Asian elephant, springbok, African elephant, large cats, brown bear, painted hunting dog, long-tailed mole, pygmy hippopotamus, dhole, lesser panda, Persian cat, wild boar, two-humped camel, cow heron, yellow mongoose, Indian elephant, axis deer, bobcat, red wolf, bat, betta, icefish, sunfish, scallop, seahorse, seal, starfish, blue whale, giant squid, goldfish, hammer fish, giant pacific octopus, budgerigar, snowy owl, emperor penguin, white stork, white-winged woodpecker, blackbird, two-toed ostrich, gray heron, gray sparrow, hen, mountain eagle, pink flamingo, black swan, gray partridge, hooded crane, black swift, gray goose, white gull, screech-owl, yellow scorpion, May beetle, house cricket, Colorado beetle, ladybug, orange grasshopper, singing grasshopper, field cricket, housefly, luna moth, monarch butterfly, nomadic ants, human botfly, black scorpion, fire ant", "fish": "shark, vobla, whale, dolphin, octopus, Crab, anchovy, Barracuda, Beluga, Pigfish, devilfish, Humpback, Guppy, Carp, Kilka, Orca, Saury, Sardine, Herring, Gudgeon, Mackerel, Jellyfish, Octopus, Capelin, Mussels, Halibut, Squid, Crawfish, Lobster, Cod, Tuna, Eel, Trout, Salmon, Piranha, Corals, Plankton, Walrus, Skate, Seal, Shrimps, Shellfish, Shell, Cuttlefish, Perch, Sturgeon", "bird": "Stork, sparrow, raven, crow, pigeon, goose, thrush, woodpecker, lark, crane, turkey, canary, cuckoo, hen, partridge, swallow, swan, eagle, peacock, cock, parrot, owl, falcon, nightingale, magpie, ostrich, grouse, duck, pheasant, flamingo, heron, seagull, hawk, penguin, tit, pelican, kite, vulture, Erne, Colibri, Rook, Jay, Bullfinch, Siskin, Neophron, Hazel-hen, eagle-owl, Burgomaster, Redshank, Swift, Mallard", "insect": "butterfly, Locust, caterpillar, bedbug, mosquito, moth, ant, fly, wasp, spider, bee, scorpion, cockroach, worm, beetle, mosquito, grasshopper, Cricket, Firefly, Changa, Hornet, Bumblebee, Gadfly, Mantis, flea, Dragonfly, Mosquito, Gerris, Cicada, Mosquito, Daddy-long-legs, Tarantula, Termite, Tick, Worm, Gadfly, Centipede, Flea, Bloodworm, Louse, Weevil, Caterpillar, Midge" }, "plant": { "vegetables": "Artichoke, Basil, Beans, Cabbage, Broccoli, Peas, zucchini, Parsley, Radish, Potato, Potato, Corn, Onion, Carrot, Cucumber, Patisson, Pepper, Turnip, Rucola, Salad, Beetroot, Celery, Asparagus, Tomato, Tomato, Pumpkin, Dill, Beans, Cherry, Garlic, Spinach, Sorrel, rutabaga, corn, mooli, haricot, Carrot, Eggplant", "fruits": "Avocado, Apricot, Orange, Pineapple, Watermelon, Banana, Pomegranate, Grapefruit, Pear, Melon, Peach, Pomelo, Kiwi, Coconut, Lemon, Tangerine, Persimmon, Nectarine, Apple, Mango, Lime, Bergamot, Maracuya, Papaya", "berries": "Berries, Cherry, Cherry, Rowan, Plum, Raspberry, Blackberry, Snowball, Hackberry, Mulberry, Clusterberry, strawberry, Cranberry, Currant, Blueberry, Grapes, gooseberry", "phrases": "Bell pepper, Pak Choi, Black radish, Sweet pepper, Cauliflower, Common barberry, Yellow honeysuckle, Orpin, Wild strawberry, White clover, Alpine forget-me-not, Wild orchid, Wild radish, Bush rose, Turfing daisy, Red onion, Goji berries, Argan tree, Star apple, White willow, Coconut tree, Coral tree", "flowers": "Adonis, Azalea, Aloe, Aster, Bamboo, Barberry, Hogweed, Verbena, Carnation, Gerbera, Hyacinth, Gladiolus, hydrangea, jasmine, honeysuckle, Iris, cornflower, Cypress, Clover, Lavender, Lily-of-the-valley, Lily, Lotus, Buttercup, Magnolia, Poppy, Mimosa, Mint, Narcissus, Forget-me-not, Dandelion, Orchid, Sedge, Peony, Sunflower, Sunflower, Sage, Rose, Daisy, Tulip, Violet, Heirloom, Chrysanthemum", "trees": "Spruce, Palmtree, Lilac, Ficus, Eucalyptus, Acacia, Baobab, Birch, Oak, Willow, Chestnut, Cedar, Ash, Maple, Linden, Larch, Aspen, Fir, Rowan, Sakura, Pine, Poplar, Apple-tree" }, "tool": { "hand": "Scissors, Naildrawer, Ladder, Hacksaw, Pliers, Pry, Tyre Lever, pipe cutter, glass cutter, Pyrocutter, Nippers, Screwdriver, Drill, hammer, Clippers, Flat-nose pliers, Multimeter, Precise tweezer, Beam compass, Tape-measure, Angle meter, File, Nails, Screw, Bolt, Nut, Screw, Drill, Drift, Hammer, Workbench, Chisel, Wood plain, Former, Paint, Ax, Sledgehammer, Extension cable, Cable, Socket, Pallet, Force cup, Shovel, Adhesive tape, Pike, Perforator, Saw, Garden pruner", "electric": "Electric jigsaw, Screwdriver, Pipe bender, Thermocutter, Plasma cutter, Soldering-iron, Angle grinder, Chainsaw, Electric saw, Concrete mixer, Hot air gun", "phrases": "Utility knife, Craft knife, Diamond sharpener, Wire brush, Blacksmith hammer, Hand saw, Phillips screwdriver, Band saw, Lathe, Welding machine, Grinding machine, Milling machine, Hot knife, Vacuum pump, Laser cutter, Laser level, Kneepiece, Paint brush, Rubber gloves, Protective gloves, Rubber boots, Rubber hammer, Wrench, Construction mixer" }, "furniture": { "single": "Bar, library, buffet, buffet, hanger, hammock, wardrobe, suite, Sofa, Mirror, Cradle, chest of drawers, console, armchair, bed, couch, Pencil case, shelf, pouf, camp-bed, safe, sideboard, bench, sofa, rack, wall cabinet, table, chair, stool, ottoman, throne, dressing table, bedside table, Lounge, folding screen, wardrobe, cupboard, shelf, chairs, bedside table, bench, countertop", "phrases": "Wall hanger, Playpen, Office sofa, Massage chair, Rocking chair, Crib, Wall shelf, Bookshelf, Office rack, Writing desk, Computer desk, Coffee table, Bar stool, Theater chair, Built-in wardrobe" }, "crockery": { "cooking": "Casserole, Frying pan, Frying pan, Saucepan, Teapot, Rolling pin, Chopper, Grater, Masher, Opener, Peeler, Tray, Wok, Pressure pan, Coffee-grinder, Coffee machine, Ladle, Spatula, Skimmer, Pot, Blender, Mixer, Food steamer, Juicer, Coffee-pot, Toaster, Blender, Electric kettle, Ladle, Steamer", "eat": "Salad bowl, Plate, Bowl, Glass, Mug, Cup, Bowl, Knife, Fork, Spoon, Sauce bowl, Sugar bowl, Tray, Glass, Service, Jug, container, Thermos, Saltcellar, Pepperbox, Sugar bowl,shotglass, Wineglass", "phrases": "Teaspoon, Tablespoon, Fruit basket, Wooden spoon, Cutting board, Clay pot, Food processor, Tea set, Serving plate, Salad fork, Wooden spatula, Measuring spoon, Measuring cup, Can opener, Soup plate, Electric kettle, Dessert plate, Fruit fork, Fruit knife, Pancake pan" }, "transport": { "land": "Bus, Autocar, Car, Train, Carriage, Train, Tram, Trolley, Truck, Tripper-car, Forklift, Waggon, Jeep, Convertible, Snowmobile, Monorail, Motorcycle, Scooter, Lorry, Taxi, Subway, Bulldozer, Excavator, Scooter, Lokomotiv, Van, Steam Engine, Electric Train, Harvester, Tracttion Engine, Cable Railway", "water": "Ship, Steamboat, Barge, Vessel, Yacht, Ferry, Regatta, Powerboat, Oil-ship, Liner, Tanker, Battleship, Cruiser, Icebreaker, Galley, Frigate, Schooner", "air": "Airplane, helicopter, Rocket, Airship, Hang-glider, Airplane, Shuttle, Aerostat, Paraglider", "hand": "Bicycle, Sledge, Cart, Coach, Boat, Canoe, Parachute, Scooter, Rickshaw, Catamaran, Boat, Kayak, Wagon", "phrases": "School bus, High-speed train, Freight train, Race car, Cruise ship, Motor boat, Submarine, Cargo ship, Passenger liner, Fire truck, Luggage car, Balloon, Dog sled" }, "sport": { "single": "Badminton, Rugby, Volleyball, Basketball, Football, Skateboarding, Shooting, Tennis, Baseball, Cycling, Golf, Handball, Gymnastics, Fitness, Mountaineering, Billiards, Bowling, Darts", "fighting": "Aikido, Boxing, Judo, Karate, Kickboxing, Wrestling, Sambo, Wushu, Fencing, Martial Arts, Wrestling", "phrases": "Figure skating, Snow rugby, Alpine skiing, Cross-country skiing, Sledding, Mountain snowboarding, Water skiing, Synchronized swimming, Water polo, Sailing, Hand-to-hand combat, Combat Sambo, Wrestling, Graeco-Roman Wrestling, Rowing, Equestrianism, Track-and-field Athletics, Table tennis, Kettlebell lifting", "winter": "Hockey, Biathlon, Skeleton, Bobsleigh, Freestyle, Snowboard, Curling", "water": "Kayaking, Swimming, Surfing, Rowing, Diving, Windsurfing, Regatta", "equipment": "ball, sneakers, rackets, Gloves, skip-rope, barbell, dumbbell, kettlebell, hoop, whistle, helmet, top, skates, stick, washer, bar, bars, ring, bat, Target, Darts, cleats, kimono, bowl, pins, rope, Fitball, Hoop, Shorts, Rifle, Bicycle, Sledge, Sneakers, Espander, Skis, Tatami, trampoline, fins, Tap, ​​Timer, Cup, medal, Canvas, stockings, shields, shot, discis, goal, apparatus, gear" }, "body": { "outer": "Thigh, Biceps, Eyelids, Hair, Eyes, Orbit, Pharynx, Ankle, Leg, Head, Throat, Larynx, Sternum, Lips, Diaphragm, Stomach, Abdomen, Carpus, Teeth, Adam's-Apple, Wrist, Bowel, Skin, Collarbone, Knee, Bones, Lungs, Face, Forehead, Ankle, Elbow, Shoulder, Shieldbone, Muscles, Nails, Nose, Finger, Liver, Shoulder, Chin, Spine, Kidney, Ribs, Eyelashes, Mouth, Hand, Heart, Skeleton, Foot, Joint, Ear, Ears, Skull, Jaw, Neck, Cheeks", "inner": "Adrenaline, Amino acids, Antibodies, Aorta, Artery, Proteins, Bronchi, Veins, Viruses, Blood, Hemoglobin, Genes, Hypophysis, Hormones, Glands, Immunity, Insulin, Capillaries, Cell, Leukocytes, Lymph, Neurons, Plasma, Reflexes, Receptors, Synapse, Carbohydrates, Platelets, Chromosomes", "phrases": "Eardrum, Thumb, Inner ear, Eyeball, Growth hormones, Chest, Blood type, Stomach acid, Blood vessels, Baby teeth, Facial muscles, Taste organ, Mouth cavity, Retina, Medulla" }, "common": { "nature": "Forest, Mountains, Sea, Ocean, River, Desert, Beach, Jungle, Grassland, Field, Meadow, Volcano, Lake, Sand, Branch, Tree, Shrub, Grass, Water, Boulder, Rubble, Sun, Moon, Canyon, Island, Plain, Hill, Pond, Rock, Stone, Flora, Clouds, Flower, Grove, Snow, Wild Resort, Fire, Swamp, Waterfall, Wave, Snowdrift, Stem, Stars, earth, space, plant, bird, animal, shore", "phenomenon": "Thunderstorm, Snowfall, Drought, Hurricane, Storm, Earthquake, Flood, Gale, Fog, Winter, Autumn, Summer, Spring, Dawn, Sunset, Day, Night, Natural Day, Fire, Rainbow, Rain, Heat, Leaf Fall, Dew, Wind, Snowstorm, Glaze, Lightning, Thunder, Tornado, Typhoon, Landflood, Blowing snow, Blizzard, Thaw, Snow-melt Flood, Hail, Hoarfrost, Twister, Low Tide, Tsunami, Eclipse, Avalanche" }, "stationery": { "simple": "Square, Pen, Pencil, Notebook, Folder, Correction fluid, Liquid paper, Marker, Ruler, Calculator, Notepad, Organizer, Glue, Paint brush, Paints, Stapler, Divider, Protractor, Pencil Sharpener, Eyelet-punch, Diary, Eraser, Clay, Paper Clips, Tape, Drawing Pins, Magnifier, Sticker, Envelope, File, Cardboard, Gouache, Ink-pot, Quill, Palette, State-pencil", "phrases": "Gel pen, Drawing folder, Colored cardboard, Colored paper, Glue-pencil, Counting sticks, Watercolor paints, Multicolored pens, Eraser, Letter opener" } }
    };
})(WordsEn || (WordsEn = {}));
...
(function (WordsRu) {
    WordsRu.data = {
        ...
        words: {
            ...
            body: {
                outer: "Бедро, Бицепс, Веки, Волосы, Глаз, Глазница, Глотка, Голеностоп, Голень, Голова, Горло, Гортань, Грудина, Губы, Диафрагма, Желудок, Живот, Запястье, Зубы, Кадык, Кисть , Кишечник, Ключица, Кожа, Колено, Кости, Легкие, Лицо, Лоб, лодыжка, Локоть, Лопатка, Мизинец, Мышцы, Ногти, Нос, Палец, Печень, Плечо, Подбородок, Позвоночник, Почка, Ребра, Ресницы, Рот, Рука, Сердце, Скелет, Стопа, Сустав, Ухо, Уши, Челюсть, Череп, Шея, Щеки",
            ...
            stationery: {
                ...
                phrases: "Гелевая ручка, Папка для черчения, Цветной картон, Цветная бумага, Клей-карандаш, Счетные палочки, Акварельные краски, Разноцветные ручки, Стиральная резинка, Канцелярский нож"
            }
        }
    };
})(WordsRu || (WordsRu = {}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_utils_index__ = __webpack_require__(/*! core/utils/index */ 8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(/*! lodash */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__words__ = __webpack_require__(/*! ./words */ 194);
...
var Logic = /** @class */ (function (_super) {
    ...
    Logic.prototype.createTutorial = function () {
        var _this = this;
        if (this.index >= __WEBPACK_IMPORTED_MODULE_4__words__["b" /* WordMasterWords */].tutorial.length) {
            return undefined;
        }
