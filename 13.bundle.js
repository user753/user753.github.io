...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__levels__ = __webpack_require__(/*! ./levels */ 215);
...
(function (Sounds) {
    ...
    Sounds.paper = "paper";
    Sounds.keys = [Sounds.bg, Sounds.folder, Sounds.paper];
})(Sounds || (Sounds = {}));
var Translations;
...
(function (Fonts) {
    Fonts.word = {
        fontSize: 100, font: __WEBPACK_IMPORTED_MODULE_0_core_assets_fonts__["c" /* CoreFonts */].MontserratSemiBold, fill: __WEBPACK_IMPORTED_MODULE_0_core_assets_fonts__["b" /* CoreColors */].lightBlack, align: "center"
    };
})(Fonts || (Fonts = {}));
var Images;
(function (Images) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_games_polyglot_wordsort_words__ = __webpack_require__(/*! games/polyglot/wordsort/words */ 216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_ui_components_games_introAnimationComponent__ = __webpack_require__(/*! core/ui/components/games/introAnimationComponent */ 162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_ui_controls_behaviors_textOnCenterBehavior__ = __webpack_require__(/*! core/ui/controls/behaviors/textOnCenterBehavior */ 159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_core_ui_services_instances__ = __webpack_require__(/*! core/ui/services/instances */ 1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__ = __webpack_require__(/*! games/polyglot/wordsort/assets */ 201);
...
var MainComponent = /** @class */ (function (_super) {
    ...
    function MainComponent() {
        ...
        _this.taskText = _this.add(new __WEBPACK_IMPORTED_MODULE_7_core_ui_components_games_gameUI_textPanelComponent__["a" /* TextPanelComponent */]({ size: _this.current(_this.biPositions.taskSize) }))
            .setBiPos(__WEBPACK_IMPORTED_MODULE_3_core_ui_common_positions__["a" /* BiValue */].map(_this.biPositions.taskText, function (_a) {
            var y = _a.y;
            return ({ x: __WEBPACK_IMPORTED_MODULE_4_core_ui_common_sizes__["a" /* Sizes */].w2, y: y });
        })).anchorCenter()
            .onBiValueChange(_this.biPositions.taskSize, function (x, v) { return x.changePanel({ size: v }); });
        ...
        _this.paperAll = _this.paperGroup.add(_this.makeImage(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["b" /* Images */].paper_all).anchorCenter()).onBiValueChange(biValues.paperScale, function (c, v) { return c.symmetricScale = v; });
        _this.zaglushka = _this.paperGroup.add(_this.makeImage(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["b" /* Images */].zaglushka).anchorCenter());
    ...
    MainComponent.prototype.createArrow = function (right) {
        var pos = __WEBPACK_IMPORTED_MODULE_14_core_utils_objects__["a" /* Objects */].update(this.positions.arrow, { x: function (x) { return __WEBPACK_IMPORTED_MODULE_4_core_ui_common_sizes__["a" /* Sizes */].w2 + __WEBPACK_IMPORTED_MODULE_13_core_utils_numbers__["a" /* Numbers */].sign(right) * x; } });
    ...
    MainComponent.prototype.createButton = function (right) {
        var pos = __WEBPACK_IMPORTED_MODULE_3_core_ui_common_positions__["a" /* BiValue */].map(this.biPositions.button, function (_a) {
            var x = _a.x, y = _a.y;
        ...
        var arrow = this.createArrow(right).onBiValueChange(biValues.arrowVisible, function (x, v) {
            x.visible = v;
        });
    ...
    MainComponent.prototype.createTaskPaper = function () {
        ...
        var textOnCenter = new __WEBPACK_IMPORTED_MODULE_8_core_ui_controls_behaviors_textOnCenterBehavior__["a" /* TextOnCenterBehavior */](__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["a" /* Fonts */].word, this.positions.wordMargin);
        var paper = this.paperGroup.add(this.makeImage(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["b" /* Images */].paper)).updatePos(0, this.positions.paper.y).anchorCenter()
            .addBehavior(textOnCenter).onBiValueChange(biValues.paperScale, function (c, v) { return c.symmetricScale = v; });
    ...
    MainComponent.prototype.animationPaper = function () {
        ...
        if (oldPaper) {
            this.playSound(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["c" /* Sounds */].paper);
            ...
            var to = __WEBPACK_IMPORTED_MODULE_12_core_ui_services_instances__["e" /* screenSizeService */].isPortrait
                ? this.current(this.biPositions.paperInFolder)
                : __WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */]({}, this.current(this.biPositions.paperInFolder), { angle: [sign * -10, sign * 10] });
    ...
    MainComponent.prototype.animationButton = function (right) {
        this.playSound(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["c" /* Sounds */].folder);
        var btn = this.btns[right ? 1 : 0].btn;
        __WEBPACK_IMPORTED_MODULE_2_core_ui_animations_tweens__["a" /* Tweens */].start({
            target: btn,
            to: { y: btn.y + this.positions.animation.y, angle: __WEBPACK_IMPORTED_MODULE_13_core_utils_numbers__["a" /* Numbers */].sign(right) * 5 },
            easing: Phaser.Easing.Sinusoidal.InOut,
    ...
    MainComponent.prototype.onNewTask = function (task) {
        ...
        var taskText = this.translate(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["d" /* Translations */].task) + "\n" +
            this.translate(__WEBPACK_IMPORTED_MODULE_15_games_polyglot_wordsort_assets__["d" /* Translations */].category(task.category));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_games_polyglot_wordsort_assets__ = __webpack_require__(/*! games/polyglot/wordsort/assets */ 201);
...
var FolderComponent = /** @class */ (function (_super) {
    ...
    FolderComponent.prototype.onInit = function () {
        ...
        this.img = this.addImage(__WEBPACK_IMPORTED_MODULE_3_games_polyglot_wordsort_assets__["b" /* Images */].icon(0, true)).setPos(this.positions.icon).anchorCenter();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_utils_circleSeq__ = __webpack_require__(/*! core/utils/circleSeq */ 157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_games_polyglot_wordsort_words__ = __webpack_require__(/*! games/polyglot/wordsort/words */ 216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(/*! lodash */ 2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__levels__ = __webpack_require__(/*! ./levels */ 215);
