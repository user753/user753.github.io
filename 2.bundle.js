...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_games_polyglot_wordmaster_images__ = __webpack_require__(/*! games/polyglot/wordmaster/images */ 200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_mainComponent__ = __webpack_require__(/*! ./components/mainComponent */ 296);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__levels__ = __webpack_require__(/*! ./levels */ 299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__logic__ = __webpack_require__(/*! ./logic */ 300);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_ui_common_sizes__ = __webpack_require__(/*! core/ui/common/sizes */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_ui_components_games_gameUI_textPanelComponent__ = __webpack_require__(/*! core/ui/components/games/gameUI/textPanelComponent */ 162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_games_polyglot_common_components_baseWordMainComponent__ = __webpack_require__(/*! games/polyglot/common/components/baseWordMainComponent */ 178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_games_polyglot_wordmaster_components_typeWriterComponent__ = __webpack_require__(/*! games/polyglot/wordmaster/components/typeWriterComponent */ 297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_games_polyglot_wordmaster_images__ = __webpack_require__(/*! games/polyglot/wordmaster/images */ 200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_games_polyglot_wordmaster_translations__ = __webpack_require__(/*! games/polyglot/wordmaster/translations */ 298);
...
var MainComponent = /** @class */ (function (_super) {
    ...
    function MainComponent() {
        ...
        _this.positionsPortrait2 = __WEBPACK_IMPORTED_MODULE_2_core_ui_common_sizes__["a" /* Sizes */].update(_this.positions2, {
            descY: 150,
    ...
    MainComponent.prototype.onInit = function () {
        ...
        this.positions = __WEBPACK_IMPORTED_MODULE_2_core_ui_common_sizes__["a" /* Sizes */].update(this.positions, {
            tutorial: { y: 40 },
            mainGroup: { y: 180 },
            wordlistOffset: { x: 0, y: (this.isTutorial && __WEBPACK_IMPORTED_MODULE_5_core_ui_services_instances__["e" /* screenSizeService */].isPortrait) ? -140 : 0 }
        });
        ...
        this.textPanel = this.mainGroup.add(new __WEBPACK_IMPORTED_MODULE_3_core_ui_components_games_gameUI_textPanelComponent__["a" /* TextPanelComponent */]({ size: this.getPositions2().wordWidth, color: __WEBPACK_IMPORTED_MODULE_8_games_polyglot_wordmaster_images__["a" /* Colors */].panel }))
            .updatePos(__WEBPACK_IMPORTED_MODULE_2_core_ui_common_sizes__["a" /* Sizes */].w2, this.getPositions2().descY).anchorCenter();
    };
    MainComponent.prototype.createTutorial = function () {
        return this.add(this.createComponent(__WEBPACK_IMPORTED_MODULE_4_core_ui_components_games_gameUI_tutorialTextComponent__["a" /* TutorialTextComponent */])).make({ panel: { color: __WEBPACK_IMPORTED_MODULE_8_games_polyglot_wordmaster_images__["a" /* Colors */].panel } });
    };
    MainComponent.prototype.onNewTask = function (task) {
        ...
        if (this.tutorial) {
            ...
            this.tutorial.setProps(__WEBPACK_IMPORTED_MODULE_1_core_services__["h" /* translationService */].getTranslation(key));
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_games_polyglot_common_components_baseTypewriterComponent__ = __webpack_require__(/*! games/polyglot/common/components/baseTypewriterComponent */ 183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__images__ = __webpack_require__(/*! ../images */ 200);
...
var TypeWriterComponent = /** @class */ (function (_super) {
    ...
    TypeWriterComponent.prototype.onInit = function () {
        ...
        _super.prototype.onInit.call(this);
        this.keyboard = this.addImage([__WEBPACK_IMPORTED_MODULE_5__images__["b" /* Images */].type_keyboard, [this.height / 2, this.positions2.keyboardY]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_utils_strings__ = __webpack_require__(/*! core/utils/strings */ 67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_utils_tuples__ = __webpack_require__(/*! core/utils/tuples */ 24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_games_polyglot_wordmaster_words__ = __webpack_require__(/*! games/polyglot/wordmaster/words */ 301);
...
var Logic = /** @class */ (function (_super) {
    ...
    Logic.prototype.modify = function (type, anagramma) {
        switch (type) {
            case "hide": {
                var firstLetter = anagramma.word[0];
                var duplicateLetters = __WEBPACK_IMPORTED_MODULE_7_lodash__["toPairs"](__WEBPACK_IMPORTED_MODULE_7_lodash__["groupBy"](anagramma.word.split(""), function (x) { return x; }))
                    .filter(function (_a) {
                    var k = _a[0], v = _a[1];
                    return v.length > 1;
                }).map(function (x) { return x[0]; });
                var noLetters_1 = duplicateLetters.concat([firstLetter]);
                var noLettersIndexes = anagramma.anagramma.split("").map(function (l, i) { return Object(__WEBPACK_IMPORTED_MODULE_5_core_utils_tuples__["a" /* tuple */])(l, i); })
                    .filter(function (_a) {
                    var l = _a[0], i = _a[1];
                    return __WEBPACK_IMPORTED_MODULE_7_lodash__["includes"](noLetters_1, l);
                })
                    .map(function (x) { return x[1]; });
                var hideIndex = this.rng.uniqArray(anagramma.word.length, 1, 0, noLettersIndexes);
                return __WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */]({}, anagramma, { hideIndex: hideIndex[0] || 0 });
            }
            case "extra":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_games_polyglot_wordmaster_wordsEn__ = __webpack_require__(/*! games/polyglot/wordmaster/wordsEn */ 302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_games_polyglot_wordmaster_wordsRu__ = __webpack_require__(/*! games/polyglot/wordmaster/wordsRu */ 303);
...
(function (AnagrammaWords) {
    ...
    AnagrammaWords.items = function (locale) {
        var data = __WEBPACK_IMPORTED_MODULE_2_games_utils_localeUtl__["a" /* LocaleUtl */].getData(localeData, locale)
            ...
            return [head.toLowerCase()].concat((tail.filter(function (x) { return x != ""; })));
        });
...
(function (WordsRu) {
    WordsRu.data = [
        ...
        ["селен", "Химический элемент, серо-чёрный металлоид", "Обычно добывается из отходов при выработке серной кислоты"],
